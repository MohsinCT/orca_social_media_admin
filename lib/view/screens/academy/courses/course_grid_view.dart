...
class CourseGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream: courseController.filteredCourses.stream,
        builder: (context, snapshot) {
          return Obx(() {
            // ignore: invalid_use_of_protected_member
            final courses = courseController.filteredCourses.value;
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          print(
                              "Encoded JSON ${Uri.encodeComponent(jsonString)}");
